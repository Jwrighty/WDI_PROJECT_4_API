...
Word.create([
  ...
  {symbol: 'こんにちは', romaji: 'konnnichiwa', meaning: 'Hello'},
  {symbol: 'こんばんは', romaji: 'konbannwa', meaning: 'Good Evening'},
  {symbol: 'さようなら', romaji: 'sayounara', meaning: 'Goodbye'},
  {symbol: 'ありがとう', romaji: 'arigatou', meaning: 'Thank You'},
  {symbol: 'ごめんなさい', romaji: 'gomennnasai', meaning: 'Sorry'},
  {symbol: 'すみません', romaji: 'sumimasenn', meaning: 'Excuse Me'},
  {symbol: 'はじめまして', romaji: 'hajimemashite', meaning: 'Nice to meet you'},
  {symbol: 'いただきます', romaji: 'itadakimasu', meaning: 'Bon appetite!'},
  {symbol: 'ようこそ', romaji: 'yokoso', meaning: 'Welcome'},
  # Foods
